...
export const metadata: Metadata = {
  ...
  description:
    "Carreto, mudanca e guincho em Osasco e Zona Oeste SP. Manda foto e recebe o preco na hora pelo WhatsApp. A partir de R$ 150. Rapido, acessivel e sem burocracia.",
  keywords: [
    "carreto osasco",
    "carreto zona oeste",
    "mudanca osasco",
    "frete osasco",
    "carreto barato osasco",
    "mudanca barata osasco",
    "guincho osasco",
    "guincho 24 horas osasco",
    "carreto perto de mim",
    "frete pelo whatsapp",
    "mudanca residencial osasco",
    "pequenos fretes osasco",
  ],
  authors: [{ name: "Pegue" }],
  creator: "Pegue",
  publisher: "Pegue",
  ...
  twitter: {
    ...
    title: "Pegue - Carreto, Mudanca e Guincho em Osasco",
    description: "Carreto e mudanca a partir de R$ 150. Preco na hora pelo WhatsApp.",
    images: ["/og-image.png"],
  },
  robots: {
    index: true,
...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR" className={`${inter.variable} ${bricolage.variable} h-full antialiased`}>
      <head>
        <script
