  ...
  try {
    ...
    const result = await preference.create({
      body: {
        ...
        back_urls: {
          success: "https://pegue-eta.vercel.app/teste-pagamento?status=ok",
          failure: "https://pegue-eta.vercel.app/teste-pagamento?status=erro",
          pending: "https://pegue-eta.vercel.app/teste-pagamento?status=pendente",
        },
